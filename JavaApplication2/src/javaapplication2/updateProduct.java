...
public class updateProduct extends JPanel {
    ...
    private void initComponents() {
        ...
        query = java.beans.Beans.isDesignTime() ? null : entityManager.createQuery("SELECT p FROM Productcatalogue2 p");
        ...
        columnBinding.setColumnName("Prodid");
        columnBinding.setColumnClass(Integer.class);
        columnBinding = jTableBinding.addColumnBinding(org.jdesktop.beansbinding.ELProperty.create("${dealerid}"));
        ...
        org.jdesktop.beansbinding.Binding binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, masterTable, org.jdesktop.beansbinding.ELProperty.create("${selectedElement.prodid}"), prodidField, org.jdesktop.beansbinding.BeanProperty.create("text"));
        binding.setSourceUnreadableValue("null");
        bindingGroup.addBinding(binding);
        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ, masterTable, org.jdesktop.beansbinding.ELProperty.create("${selectedElement != null}"), prodidField, org.jdesktop.beansbinding.BeanProperty.create("enabled"));
        bindingGroup.addBinding(binding);
        ...
        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, masterTable, org.jdesktop.beansbinding.ELProperty.create("${selectedElement.dealerid}"), dealeridField, org.jdesktop.beansbinding.BeanProperty.create("text"));
        binding.setSourceUnreadableValue("null");
        bindingGroup.addBinding(binding);
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(prodidField, javax.swing.GroupLayout.DEFAULT_SIZE, 315, Short.MAX_VALUE)
    ...
    private class FormListener implements java.awt.event.ActionListener {
        ...
        public void actionPerformed(java.awt.event.ActionEvent evt) {
            if (evt.getSource() == saveButton) {
                updateProduct.this.saveButtonActionPerformed(evt);
            }
            else if (evt.getSource() == refreshButton) {
                updateProduct.this.refreshButtonActionPerformed(evt);
            }
            else if (evt.getSource() == newButton) {
                updateProduct.this.newButtonActionPerformed(evt);
            }
            else if (evt.getSource() == deleteButton) {
                updateProduct.this.deleteButtonActionPerformed(evt);
            }
        }
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        ...
        List<javaapplication2.Productcatalogue2> toRemove = new ArrayList<javaapplication2.Productcatalogue2>(selected.length);
        for (int idx = 0; idx < selected.length; idx++) {
            javaapplication2.Productcatalogue2 p = list.get(masterTable.convertRowIndexToModel(selected[idx]));
            toRemove.add(p);
    ...
    private void newButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newButtonActionPerformed
        javaapplication2.Productcatalogue2 p = new javaapplication2.Productcatalogue2();
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        try {
            ...
            rex.printStackTrace();
            entityManager.getTransaction().begin();
            List<javaapplication2.Productcatalogue2> merged = new ArrayList<javaapplication2.Productcatalogue2>(list.size());
            for (javaapplication2.Productcatalogue2 p : list) {
                merged.add(entityManager.merge(p));
            }
            list.clear();
            list.addAll(merged);
            JOptionPane.showMessageDialog(null, "Can't add.Registered dealer not found", "Error", JOptionPane.ERROR_MESSAGE, null);
        }
    ...
    private java.util.List<javaapplication2.Productcatalogue2> list;
